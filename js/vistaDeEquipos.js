    ...
    $("#equipos").append(`<div class="col">
                            <div class="card border-2 rounded-3">
                              <div class="card-header equipo__titulo">
                                <h5 class="card-title col-10 mb-0 align-self-center text-start text-truncate">${equipo.nombre}</h5>
                                <button id="modify-${equipo.id}" type="button" class="col-1 btn btn-light p-0 p-sm-1 me-1">
                                ...
                                <button id="close-${equipo.id}" type="button" class="col-1 btn btn-light p-0 p-sm-1">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="#dc3545" class="bi bi-x-square" viewBox="0 0 16 16">

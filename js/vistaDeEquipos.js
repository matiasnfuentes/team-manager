    ...
    $("#equipos").append(`<div class="col">
                            <div class="card border-2 rounded-3">
                              <div class="card-header equipo__titulo">
                                <h5 class="card-title col-8 col-sm-10 mb-0 align-self-center text-start text-truncate">${equipo.nombre}</h5>
                                <button id="modify-${equipo.id}" type="button" class="col-2 col-sm-1 btn btn-light p-1 me-1">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="#0d6efd" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                    <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                    <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                  </svg>
                                </button>
                                <button id="close-${equipo.id}" type="button" class="col-2 col-sm-1 btn btn-light p-1">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="#0d6efd" class="bi bi-x-square" viewBox="0 0 16 16">
...
function mostrarEquipos(equipos) {
    $("#body").html(`<div class ="col-12 col-sm-8 col-lg-5 align-self-center">
                    ...
                    <div id ="equipos" class="row row-cols-1 row-cols-sm-2 row-cols-xxl-3 g-4 col-12 col-lg-10 align-self-center"></div>`);
